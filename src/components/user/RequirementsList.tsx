...
export const RequirementsList = ({
  ...
  const [selectedViewRequirement, setSelectedViewRequirement] =
      ...
      <Card className="border-dashed border-2 border-slate-400/50 bg-gradient-to-br from-slate-800/80 to-slate-700/80">
        <CardContent className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-sm text-slate-300 text-center mb-6 max-w-md">
            Get started by submitting your first website requirement. Our team
            will review it and get back to you soon.
          </p>
          <Button
            onClick={onShowNewRequirement}
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {requirements.map((requirement) => {
            ...
            return (
              <Card
                key={requirement.id}
                className="hover:shadow-md transition-shadow relative border-slate-600/50"
              >
                {/* Rejection indicator */}
                {requirement.rejected_by_client && (
                ...
                <CardHeader className="pb-3">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <Badge
                      variant="outline"
                      className={getStatusBadgeVariant(requirement)}
                    >
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-green-100 mt-1">
                            The admin has addressed your concerns and reopened
                  ...
                  {requirement.rejected_by_client &&
                    requirement.rejection_reason && (
                      <div className="bg-orange-800/30 border border-orange-500/50 rounded-lg p-3 mb-4">
                        ...
                        {requirement.admin_response_to_rejection && (
                          <>
                            <h4 className="text-sm font-medium text-orange-200 mb-1 mt-2">
                              Admin Response:
                            </h4>
                            <p className="text-sm text-orange-100">
                              {requirement.admin_response_to_rejection}
